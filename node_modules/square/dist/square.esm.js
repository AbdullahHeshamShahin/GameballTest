        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject$l(), mapped.siteId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject2$e(), mapped.siteId);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject3$a(), mapped.siteId);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject2$f(), mapped.subscriptionId);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject3$b(), mapped.subscriptionId);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject2$g(), mapped.teamMemberId);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject3$c(), mapped.teamMemberId);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject2$h(), mapped.checkoutId);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject3$d(), mapped.terminalRefundId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              req.query('sort_order', mapped.sortOrder);
              req.query('cursor', mapped.cursor);
              req.appendTemplatePath(_templateObject2$i(), mapped.locationId);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject3$e(), mapped.locationId);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject2$j(), mapped.employeeId);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject3$f(), mapped.roleId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject2$k(), mapped.locationId, mapped.orderId);
...
var SDK_VERSION = '11.0.0';
var USER_AGENT = 'Square-TypeScript-SDK/11.0.0';
...
function getBaseUri(server, config) {
  ...
  if (config.environment === Environment.Custom) {
    if (server === 'default') {
      return pathTemplate(_templateObject$s(), new SkipEncode(config.customUrl));
    }
  }
...
export { ApiError, ApplePayApi, BankAccountsApi, BookingsApi, CashDrawersApi, CatalogApi, CheckoutApi, Client, CustomerGroupsApi, CustomerSegmentsApi, CustomersApi, DEFAULT_CONFIGURATION, DevicesApi, DisputesApi, EmployeesApi, Environment, InventoryApi, InvoicesApi, LaborApi, LocationsApi, LoyaltyApi, MerchantsApi, MobileAuthorizationApi, OAuthApi, OrdersApi, PaymentsApi, RefundsApi, SDK_VERSION, SitesApi, SnippetsApi, SubscriptionsApi, TeamApi, TerminalApi, TransactionsApi, V1EmployeesApi, V1TransactionsApi };
